...
func New() *gin.Engine {
	...
	v1.POST("/settings/model-channel/sync", gin.WrapF(handler.SyncDesktopCloudModelChannel))
	v1.POST("/psd-tasks", gin.WrapF(handler.CreatePSDTask))
	...
	api.GET("/update/check", gin.WrapF(handler.CheckAppUpdate))
